    ...
    for(var i = (startRow - 1); i < inputLines.length; i++){
        ...
        if (ltrim(lineText).length > 0) { //if not a blank line
            ...
            if (hParamText && !firstColonIsEnd && !startsWithHash ){
                ...
                //localJSON.push(new OutputLine(lineText,hAddressText,hParamText,hValueText,hNoteText ));
                //localJSON.push([lineText,hAddressText,hParamText,hValueText,hNoteText]);
